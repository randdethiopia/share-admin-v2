                                    ...
                                    pageData.map((blog) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell className="px-6 py-4 text-[11px] text-gray-500 font-medium w-[25%]">
                                                        ...
                                                        <DropdownMenu>
                                                            <DropdownMenuTrigger asChild>
                                                                <Button
                                                                    variant="ghost"
                                                                    size="icon"
                                                                    className="h-8 w-8 rounded-lg bg-[#F3F8FF] text-gray-500 hover:bg-gray-100"
                                                                >
                                                            ...
                                                            <DropdownMenuContent align="end" className="w-36 rounded-xl">
                                                                <DropdownMenuItem
                                                                    onClick={() => openDetails(blog._id)}
                                                                    className="gap-2 text-[#3B82F6] focus:text-[#3B82F6] cursor-pointer"
                                                                >
                                                                    <Eye size={14} />
                                                                    View
                                                                </DropdownMenuItem>
                                                                {status === "PENDING" && (
                                                                    <>
                                                                        <DropdownMenuItem
                                                                            onClick={() => openConfirm("approve", blog._id)}
                                                                            disabled={isWorking}
                                                                            className="gap-2 text-[#1E8E3E] focus:text-[#1E8E3E] cursor-pointer"
                                                                        >
                                                                            <Check size={14} />
                                                                            Approve
                                                                        </DropdownMenuItem>
